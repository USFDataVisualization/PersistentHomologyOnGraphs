...
import usf.dvl.bubbleset.Intersection.State;
...
public class BubbleSet {
   ...
   *         delta
   */
  private static boolean doublePointsEqual(final Point2D p1, final Point2D p2,
      final double delta) {
    return p1.distance(p2) < delta;
  }

  public double[][] createPotentialArea(final Rectangle2D[] members,
      final Rectangle2D[] nonMembers) {
    return createPotentialArea(members, nonMembers, null, null);
  }

  public double[][] createPotentialArea(final Rectangle2D[] members,
	      final Rectangle2D[] nonMembers, Rectangle2D activeRegion) {
	    return createPotentialArea(members, nonMembers, null, activeRegion);
	  }
   ...
   */
  public double[][] createPotentialArea(final Rectangle2D[] members,
      final Rectangle2D[] nonMembers, final Line2D[] edges, Rectangle2D activeRegion) {
   ...
   */
  private boolean calculateContour(final ArrayList<Point2D> contour,
   ...
   *         extra items
   */
  private boolean[] testContainment(final ArrayList<Point2D> contour,
      final Rectangle2D bounds, final Rectangle2D[] members,
      final Rectangle2D[] nonMembers) {
   ...
   */
  private void fillPotentialArea(final Rectangle2D activeArea,
   ...
   *         otherwise
   */
  private boolean pointExists(final Point2D pointToCheck,
   ...
   */
  private Rectangle2D getCenterItem(final Rectangle2D[] items,
   ...
   */
  private void calculateLinesInfluence(final double[][] potentialArea,
   ...
   */
  private void calculateRectangleInfluence(final double[][] potentialArea,
   ...
   */
  private Point2D rerouteLine(final Rectangle2D rectangle,
